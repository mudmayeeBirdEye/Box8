        ...
        List <Messaging.SingleEmailMessage> singleEmailMessageList = new List <Messaging.SingleEmailMessage> ();
            for(Agent_Credit__c agentCreditObj : trigger.new){
                ...
                if(agentCreditObj.Agent_Email__c != 'rcsfsync@ringcentral.com' ) {
                    try {
                        ...
                        if(isExceptionOccured == false) {
                            ...
                            system.debug('targetOb&&&&&&&&&&&&&&&jectId'+targetObjectId);
                            ...
                            if(orderObj.Account__r.Partner_ID__c != null) {
                                if(orderObj.Account__r.RC_Attribution_Channel__c != null && orderObj.Account__r.RC_Attribution_Channel__c.containsIgnoreCase('Sales Agents & Resellers')) {
                                    ...
                                    */
                                    if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerSalesResellers)!= Null &&
                                           AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerSalesResellers).get(AgentCreditHelper.toAddresses)!=NULL){
                                        ...
                                        if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerSalesResellers)!= Null &&
                                            AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerSalesResellers).get(AgentCreditHelper.ccAddresses) != NULL){
                                        ...
                                        if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerSalesResellers) != Null &&
                                            AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerSalesResellers).get(AgentCreditHelper.bccAddresses) != NULL){    
                                    ...
                                    */
                                    ...
                                    if( partnerAccount != null && partnerAccount.Inside_Sales_Rep__c != null) {
                                        ...
                                        system.debug('&&&&&&&&&&&&)))99999999))))))'+ccAddress);
                                    }
                                    if(partnerAccount != null) {
                                    ...
                                    */
                                    if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerFranchiseAssoc)!= Null &&
                                         AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerFranchiseAssoc).get(AgentCreditHelper.toAddresses)!= Null){
                                    ...
                                    if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerFranchiseAssoc)!= Null && 
                                         AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerFranchiseAssoc).get(AgentCreditHelper.ccAddresses)!= Null){
                                    ...
                                    if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerFranchiseAssoc)!= Null && 
                                        AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.CurrentOwnerFranchiseAssoc).get(AgentCreditHelper.bccAddresses)!= Null ){
                    ...
                    if(agentCreditObj.ownerId == UserRC.getRCSFSyncPrimaryOwnerId) {
                        ...
                        if(orderObj != null && orderObj.Account__r.Partner_ID__c != null) {
                            if(orderObj.Account__r.RC_Attribution_Channel__c != null && orderObj.Account__r.RC_Attribution_Channel__c.containsIgnoreCase('Sales Agents & Resellers')) {
                                ...
                                ccAddress.add('virendra.singh@simplion.com');
                                */
                                if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.SalesResellers)!= Null && 
                                       AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.SalesResellers).get(AgentCreditHelper.toAddresses)!= Null){
                                ...
                                if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.SalesResellers)!=Null &&  
                                       AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.SalesResellers).get(AgentCreditHelper.ccAddresses) != Null){
                                ...
                                if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.SalesResellers)!= Null && 
                                      AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.SalesResellers).get(AgentCreditHelper.bccAddresses)!= Null ){
                                ...
                                */
                                ...
                                ccAddress.add('ankit.garg@simplion.com');
                                */
                                if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.FranchiseAssoc)!= Null && 
                                      AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.FranchiseAssoc).get(AgentCreditHelper.toAddresses) != Null){
                                 ...
                                 if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.FranchiseAssoc) != Null && 
                                     AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.FranchiseAssoc).get(AgentCreditHelper.ccAddresses) != Null ){
                                 ...
                                 if(AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.FranchiseAssoc) != Null && 
                                    AgentCreditHelper.getCcBccEmailAddresses(AgentCreditHelper.FranchiseAssoc).get(AgentCreditHelper.bccAddresses)!= Null){
                ...
                if(!String.isBlank(targetObjectId)
                    ...
                    system.debug('&&----------&&&&&--------&&&&&)))))))))'+ccAddress);
                    system.debug('&&&&&&&&&&&&)))))))))'+singleEmailMessageList);
                }
            }
